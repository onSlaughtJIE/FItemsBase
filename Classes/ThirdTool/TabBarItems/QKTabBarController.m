...
#import "FHomeVController.h"
#import "FOrderVController.h"
#import "FShopVController.h"
#import "FProfileVController.h"
...
- (void)viewDidLoad {
    ...
    [self setupChildVc:[[FHomeVController alloc] init] title:@"首页" image:@"tabBar_home" selectedImage:@"tabBar_home_click" isHiddenNavgationBar:NO];
    [self setupChildVc:[[FShopVController alloc] init] title:@"购物车" image:@"tabBar_find" selectedImage:@"tabBar_find_click" isHiddenNavgationBar:NO];
    [self setupChildVc:[[FOrderVController alloc] init] title:@"订单" image:@"tabBar_find" selectedImage:@"tabBar_find_click" isHiddenNavgationBar:NO];
    [self setupChildVc:[[FProfileVController alloc] init] title:@"我的" image:@"tabBar_me" selectedImage:@"tabBar_me_click" isHiddenNavgationBar:NO];
...
- (void)centerBtnClick:(UIButton *)btn{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"你点击了中间按钮" preferredStyle:UIAlertControllerStyleAlert];

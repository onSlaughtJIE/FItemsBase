...
/***********************************使-用-方-法*****************
 ...
 //把uuid保存到钥匙串中
 if (kStringIsEmpty([SSKeychain passwordForService:@"com.hfmz.com" account:@"user"]) ) {
 [SSKeychain setPassword:[NSString stringWithFormat:@"%@",uuidStr] forService:@"com.hfmz.com" account:@"user"];
 }
 NSString *beforStr = [SSKeychain passwordForService:@"com.hfmz.com" account:@"user"];
 ∫
 ********************************************************/
